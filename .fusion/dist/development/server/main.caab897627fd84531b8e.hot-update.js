...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  const adaptGuessesToStrength = guesses => {
    const m = 100 / (MAXLENGTH - MINLENGTH);
    console.log("M:", m, " maxlenght:", MAXLENGTH, " guesses:", guesses, " diff:", MAXLENGTH - guesses);
    return ~~(m * (MAXLENGTH - guesses));
  };
  ...
  const setNewPassword = p => {
    ...
    const a = adaptGuessesToStrength(obj.guesses_log10);
    console.log("A:", a);
    setStrength(a);
    setCopied(false);
...
//# sourceMappingURL=main.caab897627fd84531b8e.hot-update.js.map